...
b0=a0+a1*xbar;
b1=a1;
LB0=4.0156; LB1=4.0109; Le=1.838;
...
print vecno vecb0 veclimb01 veclimb02 vecb1 veclimb11 veclimb12 vece veclime;


dat=vecno|| vecb0|| veclimb01|| veclimb02|| vecb1|| veclimb11|| veclimb12|| vece|| veclime;
cols={'vecno' '_vecb0' 'veclimb01' 'veclimb02' '_vecb1' 'veclimb11' 'veclimb12' '_vece' 'veclime'};

create chart2 from dat[colname=cols];
append from dat;
brr=nrow(dat);
print brr;
