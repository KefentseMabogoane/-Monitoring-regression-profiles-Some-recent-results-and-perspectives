...
Lz=12.0;                        /*Control limit constant*/;
...
print 'Modified HWMA SLOPE TIME-VARYING All Shifts';
...
Lz=18.0;                         /*Control limit constant*/;
...
Lz=28.13;                        /*Control limit constant*/;
...
Lz=43.0;                       /*Control limit constant*/;
...
Lz=53.25;                          /*Control limit constant*/;
